 ...
 * <p> Example: You bought 10 BTC at 350 and you set a MarketChangeAlgorithm to automatically sell some (or all) of the 10 BTC you
 * purchased at a certain rate (say 375). You lock in a guaranteed rate if the market reaches that point.
 * <p> Example: Similarly, you sold 10 BTC at 350 and you want to buy back 10 more BTC at 325. This only happens when the current
